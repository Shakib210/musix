...
import { createUser, deleteUser, getAllUsers, getUserByEmail, updateUser } from "../controllers/userController";
...
router.route("/:email").get(authenticateToken, getUserByEmail).patch(...withAuthAndPermission(PERMISSIONS.UPDATE_USER), updateUser).delete(...withAuthAndPermission(PERMISSIONS.DELETE_USER), deleteUser);
